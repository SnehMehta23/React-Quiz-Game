 ...
 * @param {number|string} [props.borderWidth="0.5rem"] Thickness of the spinner.
 ...
 * the spinner.
 * @param {string} [props.screenReaderMessage="Loading..."] Message to be displayed to screen readers
